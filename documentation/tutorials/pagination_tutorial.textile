...
bc.. 
List<Employee> page2 = q.nextPage().fetch();
...
If for any reason, the connection or statement have been closed, Siena cares for re-creating them.
...
p(note). **note** nextPage/previousPage are simple actions you can use in your templates
